...
export class FakeApiClient implements IApiClient {
  ...
  onRegenerate: (payload: unknown) => Promise<RpcResponse<{ accepted: true }>> = () => Promise.resolve(ok({ accepted: true as const }))
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    regenerate: (payload: unknown) => this.record('session.regenerate', payload, this.onRegenerate(payload)),
