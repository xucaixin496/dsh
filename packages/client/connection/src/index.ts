...
import { registerPluginStoreRoutes, registerUpdaterRoutes, toFetchHandler } from '@deepseek-ai/dsh-host-apiproxy'
...
export function apply(ctx: Context, config?: ConnectionConfig): void {
  ...
  // Desktop-fork plugin-store routes (no-op unless the deployment settings file exists).
  registerPluginStoreRoutes(ctx.webServer)
