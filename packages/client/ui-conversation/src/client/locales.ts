...
export const zh = {
  ...
  'message.edit': '编辑',
  'message.resend': '重新发送',
  'message.edit.placeholder': '编辑消息…',
  'message.edit.cancel': '取消',
  'message.edit.send': '发送',
  'message.edit.hint': 'Ctrl/⌘+Enter 发送 · Esc 取消',
  'message.edit.addAttachment': '添加文件',
  'message.edit.removeAttachment': '移除附件 {name}',
...
export const en = {
  ...
  'file.unsupportedType': 'Audio and video files are not supported; upload another format',
  ...
  'message.edit.placeholder': 'Edit message…',
  'message.edit.cancel': 'Cancel',
  'message.edit.send': 'Send',
  'message.edit.hint': 'Ctrl/⌘+Enter to send · Esc to cancel',
  'message.edit.addAttachment': 'Add file',
  'message.edit.removeAttachment': 'Remove attachment {name}',
