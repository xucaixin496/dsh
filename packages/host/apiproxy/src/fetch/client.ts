...
export interface IApiClient {
  sessions: {
    ...
    regenerate(payload: RequestPayload<'session.regenerate'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.regenerate'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'session.regenerate': sessionRegenerateValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    regenerate: (payload, signal) => this.callUnary('session.regenerate', payload, signal),
