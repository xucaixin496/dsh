...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-general UpdaterItem id \'updater\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins StoreTab id \'store\'',
    ],
    replaceRisk: 'none',
