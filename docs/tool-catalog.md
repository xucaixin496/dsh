...
Read a file the user attached to this conversation. Returns the decoded text when the file is text-like, otherwise the file metadata. Use the attachment id shown with the uploaded file.
...
```json
{
  ...
  "properties": {
    "attachment_id": {
      "type": "string",
      "description": "Opaque attachment id from the conversation."
    }
  },
  "required": [
    "attachment_id"
